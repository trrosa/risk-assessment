(function() {
    ...
    alertErrorController.$inject = ['$scope', 'AlertService', '$rootScope', '$translate'];

    function alertErrorController ($scope, AlertService, $rootScope, $translate) {
        var vm = this;
        ...
        var cleanHttpErrorListener = $rootScope.$on('riskApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                ...
                if (angular.isString(errorHeader)) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('riskApp.' + fieldError.objectName + '.' + convertedField);
